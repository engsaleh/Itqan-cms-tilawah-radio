...
- المسارات الصوتية (سورة واحدة لكل مسار)
...
لذا لجلب باقي التلاوات، اعتمدت على تنفيذ طلبات متتالية باستخدام معامل `page`، مع الاستمرار في الجلب حتى الوصول إلى العدد الكلي.
